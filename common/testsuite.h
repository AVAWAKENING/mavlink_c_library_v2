...
static void mavlink_test_gnss_low_bandwidth_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_gnss_low_bandwidth_position_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gnss_low_bandwidth_position_pack(system_id, component_id, &msg , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vn , packet1.ve , packet1.vd , packet1.heading , packet1.satellites_visible , packet1.fix_type );
    mavlink_msg_gnss_low_bandwidth_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gnss_low_bandwidth_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vn , packet1.ve , packet1.vd , packet1.heading , packet1.satellites_visible , packet1.fix_type );
    mavlink_msg_gnss_low_bandwidth_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_gnss_low_bandwidth_position_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_gnss_low_bandwidth_position_send(MAVLINK_COMM_1 , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vn , packet1.ve , packet1.vd , packet1.heading , packet1.satellites_visible , packet1.fix_type );
    mavlink_msg_gnss_low_bandwidth_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
